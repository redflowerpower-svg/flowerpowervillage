...
*   **Sblocco Rapido & Azioni Dirette sulle Schede:** Ogni comanda in cucina include pulsanti rapidi per archiviare direttamente (`✓ ARCHIVE DIRECTLY`) o annullare (`✕ CANCEL`), evitando blocchi o comande orfane.
*   **Sistema Orari di Esercizio & Pause Emergenza Cucina (Website a 4 Lingue: IT, EN, TH, DE):**
    *   **Controllo dal Tablet KDS:** Tasto dedicato nell'header del KDS che apre un menu touch con pause rapide (+20m, +30m, +45m, +60m, o chiusura per stasera) e riapertura istantanea.
