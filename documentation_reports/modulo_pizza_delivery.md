...
*   **Allarme Acustico Continuo ad Alta Penetrazione:** Il modulo `src/admin/pizza/utils/kitchenAudioWakeLock.ts` impiega la **Web Audio API** nativa per sintetizzare un segnale acustico bitonale (1200Hz - 2400Hz) con squillo ininterrotto a loop. L'allarme continua a suonare a volume massimo finché lo staff della pizzeria non preme "Accetta Ordine".
