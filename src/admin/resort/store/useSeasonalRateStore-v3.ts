...
export const MOTHER_RATES: MotherRateInfo[] = [
  // 1. Fake Bungalow di Test (in prima posizione per visibilità immediata in ambiente di test)
...
export const DEFAULT_PRICES_MATRIX: Record<string, Record<number, number>> = {
  p1: { 649669: 1200, 921799: 1200, 529773: 4800, 495795: 2400, 495796: 2400, 494840: 3500, 421511: 4200, 293957: 1800, 293954: 1800, 293962: 1800, 293965: 1500, 293955: 1500, 293942: 1200, 293963: 1200, 293959: 1200, 293948: 1200, 293945: 1200, 293943: 1200, 293951: 1000, 883795: 1000 },
  p2: { 649669: 1500, 921799: 1500, 529773: 6200, 495795: 3100, 495796: 3100, 494840: 4500, 421511: 5400, 293957: 2400, 293954: 2400, 293962: 2400, 293965: 2000, 293955: 2000, 293942: 1600, 293963: 1600, 293959: 1600, 293948: 1600, 293945: 1600, 293943: 1600, 293951: 1300, 883795: 1300 },
  p3: { 649669: 1400, 921799: 1400, 529773: 5800, 495795: 2900, 495796: 2900, 494840: 4200, 421511: 5000, 293957: 2200, 293954: 2200, 293962: 2200, 293965: 1800, 293955: 1800, 293942: 1500, 293963: 1500, 293959: 1500, 293948: 1500, 293945: 1500, 293943: 1500, 293951: 1200, 883795: 1200 },
  p4: { 649669: 1300, 921799: 1300, 529773: 5200, 495795: 2600, 495796: 2600, 494840: 3800, 421511: 4500, 293957: 2000, 293954: 2000, 293962: 2000, 293965: 1600, 293955: 1600, 293942: 1300, 293963: 1300, 293959: 1300, 293948: 1300, 293945: 1300, 293943: 1300, 293951: 1100, 883795: 1100 },
  p5: { 649669: 1200, 921799: 1200, 529773: 4800, 495795: 2400, 495796: 2400, 494840: 3500, 421511: 4200, 293957: 1800, 293954: 1800, 293962: 1800, 293965: 1500, 293955: 1500, 293942: 1200, 293963: 1200, 293959: 1200, 293948: 1200, 293945: 1200, 293943: 1200, 293951: 1000, 883795: 1000 },
  p6: { 649669: 800, 921799: 800, 529773: 3200, 495795: 1600, 495796: 1600, 494840: 2200, 421511: 2800, 293957: 1200, 293954: 1200, 293962: 1200, 293965: 1000, 293955: 1000, 293942: 800, 293963: 800, 293959: 800, 293948: 800, 293945: 800, 293943: 800, 293951: 700, 883795: 700 },
  p7: { 649669: 900, 921799: 900, 529773: 3500, 495795: 1750, 495796: 1750, 494840: 2400, 421511: 3000, 293957: 1300, 293954: 1300, 293962: 1300, 293965: 1100, 293955: 1100, 293942: 900, 293963: 900, 293959: 900, 293948: 900, 293945: 900, 293943: 900, 293951: 750, 883795: 750 },
  p8: { 649669: 750, 921799: 750, 529773: 3000, 495795: 1500, 495796: 1500, 494840: 2000, 421511: 2600, 293957: 1100, 293954: 1100, 293962: 1100, 293965: 900, 293955: 900, 293942: 750, 293963: 750, 293959: 750, 293948: 750, 293945: 750, 293943: 750, 293951: 650, 883795: 650 },
  p9: { 649669: 700, 921799: 700, 529773: 2800, 495795: 1400, 495796: 1400, 494840: 1900, 421511: 2400, 293957: 1000, 293954: 1000, 293962: 1000, 293965: 850, 293955: 850, 293942: 700, 293963: 700, 293959: 700, 293948: 700, 293945: 700, 293943: 700, 293951: 600, 883795: 600 }
};
...
export const useSeasonalRateStore = create<SeasonalRateExcelStoreState>()(
  persist(
    (set, get) => ({
      ...
      resetDefaultExcelStore: () => {
        set({
          periods: DEFAULT_PERIODS,
          pricesMatrix: DEFAULT_PRICES_MATRIX,
          lastSyncMessage: 'Store ripristinato ai valori predefiniti Excel (inclusi Fake Bungalow 1 e 2)!',
          lastSyncStatus: 'idle'
        });
      },
      ...
      syncPeriodToOctorate: async (periodId: string, options?: { testOnly?: boolean }) => {
        ...
        try {
          ...
          const periodUpdates = targetRates.map((mr) => ({
          ...
          set({
            ...
            lastSyncMessage: `✅ Stagione ${period.name} (${period.dateFrom} ➔ ${period.dateTo}) sincronizzata con successo su Octorate (${isTest ? '🧪 Test Fake Bungalows 1 & 2' : '🔴 Produzione Reale'})!`
          });

          // Re-fetch automatico dei dati reali da Octorate
          try {
      ...
      syncAllPeriodsToOctorate: async (options?: { testOnly?: boolean }) => {
        ...
        set({
          syncAllRunning: true,
          lastSyncMessage: `Sincronizzazione globale bulk ${isTest ? '[TEST FAKE BUNGALOW]' : '[PRODUZIONE]'} in corso...`,
          lastSyncStatus: 'idle'
        });
        ...
        try {
          ...
          set({
            syncAllRunning: false,
            lastSyncStatus: 'success',
            lastSyncMessage: `✅ Sincronizzazione Globale Bulk completata su Octorate (${isTest ? '🧪 Test Fake Bungalows 1 & 2' : '🔴 Produzione Reale'})!`
          });
    ...
    {
      name: 'fp_seasonal_rates_excel_v3',
      merge: (persistedState: any, currentState: SeasonalRateExcelStoreState) => {
        const p = persistedState as any;
        return {
          ...currentState,
          ...p,
          testMode: p?.testMode !== undefined ? Boolean(p.testMode) : true,
          periods: (Array.isArray(p?.periods) && p.periods.length > 0) ? p.periods : DEFAULT_PERIODS,
          pricesMatrix: (p?.pricesMatrix && typeof p.pricesMatrix === 'object') ? { ...DEFAULT_PRICES_MATRIX, ...p.pricesMatrix } : DEFAULT_PRICES_MATRIX,
