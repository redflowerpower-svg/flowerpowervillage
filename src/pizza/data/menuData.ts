...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    "name_de": "Weine",
    "nameDe": "Weine",
    "description": "Carefully Curated Selection Of Italian And International Wines, Chosen To Enhance The Flavors Of Every Dish On Our Menu",
    "descriptionTh": "คัดสรรไวน์อิตาเลียนและไวน์นานาชาติชั้นเลิศอย่างพิถีพิถัน เพื่อเสริมรสชาติของทุกเมนูให้โดดเด่นและสมดุลยิ่งขึ้น",
