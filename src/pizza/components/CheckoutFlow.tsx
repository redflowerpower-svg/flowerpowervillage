      ...
      <div className="bg-stone-900 w-full max-w-md p-6 border border-stone-800 text-white relative">
        ...
        {step === 2 && (
          <div className="space-y-4">
            ...
            {/* Visualizzazione QR Code condizionale */}
            {paymentMethod === 'promptpay' && (
              <div className="bg-white p-4 flex flex-col items-center space-y-2">
                <img src={QR_URL} alt="QR PromptPay" className="w-48" />
                <p className="text-stone-900 text-xs">Paga {total} ฿</p>
              </div>
            )}
