...
export default function CheckoutFlow({ onClose, onSuccess }: Props) {
  ...
  const handleSubmit = async () => {
    // Il controllo qui è ridondante se il bottone è disabilitato, 
    // ma serve per sicurezza extra
    ...
    try {
      ...
      console.error(err);
      alert('Errore durante l\'invio. Verifica la connessione o i permessi del database.');
    } finally {
      setLoading(false);
    }
  };
