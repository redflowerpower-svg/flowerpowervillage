...
export default function CheckoutFlow({ onClose, onSuccess }: Props) {
  ...
  const { requestLocation, isLoading: locationLoading, distanceKm, isDeliverable } = useLocationStore();
        ...
        {step === 1 && (
          <div className="space-y-4">
            ...
            <div className="border border-stone-700 p-4 space-y-2">
              ...
              {distanceKm !== null && (
                <p className={`text-xs text-center ${isDeliverable ? 'text-green-400' : 'text-red-400'}`}>
