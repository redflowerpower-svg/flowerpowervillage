...
async function main() {
  try {
    console.log('========================================================================');
    console.log('🔍 DIAGNOSTICA DETTAGLIATA (V5): VERIFICA STATO TARIFFE OTA');
    console.log('========================================================================\n');
    ...
    // We explicitly add the "fields=id,name" query parameter to satisfy Octorate REST v3 requirements
