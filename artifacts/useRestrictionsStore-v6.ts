...
const generateDefaultPeriods = (): Record<string, PlannedPeriod[]> => {
  ...
  initial['main_bnb_7d'] = [
    { id: 'main_bnb_7d_p1', dateFrom: '2026-10-01', dateTo: '2026-12-31', onlyCheckoutDays: 10, strategy: 'failsafe_checkout' },
    { id: 'main_bnb_7d_p2', dateFrom: '2027-01-01', dateTo: '2027-03-31', onlyCheckoutDays: 10, strategy: 'failsafe_checkout' }
  ];
...
const generateDefaultLiveOctorate = (): Record<string, PlannedPeriod[]> => {
  ...
  initial['main_bnb_7d'] = [
    { id: 'main_bnb_7d_live_p1', dateFrom: '2026-10-01', dateTo: '2026-12-31', onlyCheckoutDays: 10, strategy: 'failsafe_checkout' },
    { id: 'main_bnb_7d_live_p2', dateFrom: '2027-01-01', dateTo: '2027-03-31', onlyCheckoutDays: 10, strategy: 'failsafe_checkout' }
  ];
...
export const useRestrictionsStore = create<RestrictionsState>((set, get) => ({
  plannedPeriods: JSON.parse(localStorage.getItem('fpv_planned_restrictions_v4') || 'null') || generateDefaultPeriods(),
  ...
  updatePlannedPeriod: (ratePlanKey, index, updatedData) => {
    ...
    if (updatedPeriods[index]) {
      ...
      localStorage.setItem('fpv_planned_restrictions_v4', JSON.stringify(updated));
    }
  },
